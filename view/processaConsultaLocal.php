    ...
    <body>
        ...
        <fieldset style="width: 50%; margin: 1px auto;"><legend> <br/> <br/> <br/> <h1> Consulta de denuncia </h1> </legend>
            ...
            <div align="center">
                ...
                $result_usuarios = " SELECT * from denuncia";
                ...
                echo"<th class='bg-primary text-white'>" . "<center>" . 'endereco' . "</center>" . "</th>";
                echo"</thead>";
                echo '<tbody>';
                while ($row_usuario = mysqli_fetch_assoc($resultado_usuarios)) {
                    echo '<tr>';
                    echo"<td class='bg-light text-dark'>" . "<center>" . $row_usuario['local'] . "</center>" . "</td>";
                    echo"<td class='bg-light text-dark'>" . "<center>" . $row_usuario['endereco'] . "</center>" . "</td>";
                    echo"</tr>";
                }
                echo"</tbody></table>";
                ?>
            ...
            <div align="center">
                <br/>
                <input onclick="window.location.href = 'telaInicial2.php';" type="button" class="btn btn-primary btn-lg" value="Voltar">
                <br/>
                <br/>
            </div>
        </fieldset>
